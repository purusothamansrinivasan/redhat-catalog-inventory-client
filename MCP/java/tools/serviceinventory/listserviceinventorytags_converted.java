/**
 * MCP Server function for List Tags for ServiceInventory
 */
...
class Get_Service_Inventories_Id_TagsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Service_Inventories_Id_TagsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_service_inventories_id_tags" + queryString;
    ...
    public static MCPServer.Tool createGet_Service_Inventories_Id_TagsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_service_inventories_id_tags",
            "List Tags for ServiceInventory",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Service_Inventories_Id_TagsHandler(config));
    }
