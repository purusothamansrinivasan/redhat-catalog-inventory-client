/**
 * MCP Server function for List ServiceCredentialTypes
 */
...
class Get_Service_Credential_TypesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Service_Credential_TypesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_service_credential_types" + queryString;
    ...
    public static MCPServer.Tool createGet_Service_Credential_TypesTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_service_credential_types",
            "List ServiceCredentialTypes",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Service_Credential_TypesHandler(config));
    }
