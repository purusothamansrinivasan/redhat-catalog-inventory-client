/**
 * MCP Server function for List ServicePlans
 */
...
class Get_Service_PlansMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Service_PlansHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_service_plans" + queryString;
    ...
    public static MCPServer.Tool createGet_Service_PlansTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_Service_PlansHandler(config));
    }
