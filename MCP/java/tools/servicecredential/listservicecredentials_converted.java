/**
 * MCP Server function for List ServiceCredentials
 */
...
class Get_Service_CredentialsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Service_CredentialsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_service_credentials" + queryString;
    ...
    public static MCPServer.Tool createGet_Service_CredentialsTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_Service_CredentialsHandler(config));
    }
