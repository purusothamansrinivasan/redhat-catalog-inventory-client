/**
 * MCP Server function for List ServiceOfferingNodes for ServiceOffering
 */
...
class Get_Service_Offerings_Id_Service_Offering_NodesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Service_Offerings_Id_Service_Offering_NodesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_service_offerings_id_service_offering_nodes" + queryString;
    ...
    public static MCPServer.Tool createGet_Service_Offerings_Id_Service_Offering_NodesTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_service_offerings_id_service_offering_nodes",
            "List ServiceOfferingNodes for ServiceOffering",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Service_Offerings_Id_Service_Offering_NodesHandler(config));
    }
