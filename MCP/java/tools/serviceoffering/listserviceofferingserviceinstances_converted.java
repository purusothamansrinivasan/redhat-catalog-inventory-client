/**
 * MCP Server function for List ServiceInstances for ServiceOffering
 */
...
class Get_Service_Offerings_Id_Service_InstancesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Service_Offerings_Id_Service_InstancesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_service_offerings_id_service_instances" + queryString;
    ...
    public static MCPServer.Tool createGet_Service_Offerings_Id_Service_InstancesTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_service_offerings_id_service_instances",
            "List ServiceInstances for ServiceOffering",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Service_Offerings_Id_Service_InstancesHandler(config));
    }
