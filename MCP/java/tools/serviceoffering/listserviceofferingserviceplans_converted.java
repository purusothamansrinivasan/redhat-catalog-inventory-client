/**
 * MCP Server function for List ServicePlans for ServiceOffering
 */
...
class Get_Service_Offerings_Id_Service_PlansMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Service_Offerings_Id_Service_PlansHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_service_offerings_id_service_plans" + queryString;
    ...
    public static MCPServer.Tool createGet_Service_Offerings_Id_Service_PlansTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_service_offerings_id_service_plans",
            "List ServicePlans for ServiceOffering",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Service_Offerings_Id_Service_PlansHandler(config));
    }
