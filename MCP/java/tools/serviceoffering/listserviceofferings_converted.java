/**
 * MCP Server function for List ServiceOfferings
 */
...
class Get_Service_OfferingsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Service_OfferingsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_service_offerings" + queryString;
    ...
    public static MCPServer.Tool createGet_Service_OfferingsTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_Service_OfferingsHandler(config));
    }
