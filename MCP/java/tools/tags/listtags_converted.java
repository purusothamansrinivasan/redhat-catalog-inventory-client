/**
 * MCP Server function for List Tags
 */
...
class Get_TagsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_TagsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_tags" + queryString;
    ...
    public static MCPServer.Tool createGet_TagsTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_TagsHandler(config));
    }
