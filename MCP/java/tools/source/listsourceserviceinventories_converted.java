/**
 * MCP Server function for List ServiceInventories for Source
 */
...
class Get_Sources_Id_Service_InventoriesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Sources_Id_Service_InventoriesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_sources_id_service_inventories" + queryString;
    ...
    public static MCPServer.Tool createGet_Sources_Id_Service_InventoriesTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_sources_id_service_inventories",
            "List ServiceInventories for Source",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Sources_Id_Service_InventoriesHandler(config));
    }
