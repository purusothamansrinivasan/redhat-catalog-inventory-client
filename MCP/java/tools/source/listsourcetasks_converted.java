/**
 * MCP Server function for List Tasks for Source
 */
...
class Get_Sources_Id_TasksMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Sources_Id_TasksHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sort_by")) {
            queryParams.add("sort_by=" + args.get("sort_by"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_sources_id_tasks" + queryString;
    ...
    public static MCPServer.Tool createGet_Sources_Id_TasksTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_sources_id_tasks",
            "List Tasks for Source",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Sources_Id_TasksHandler(config));
    }
