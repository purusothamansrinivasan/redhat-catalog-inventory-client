...
|------------- | ------------- | -------------|
| [**listServicePlans**](ServicePlanApi.md#listServicePlans) | **GET** /service_plans | List ServicePlans |
| [**showServicePlan**](ServicePlanApi.md#showServicePlan) | **GET** /service_plans/{id} | Show an existing ServicePlan |


<a id="listServicePlans"></a>
# **listServicePlans**
> ServicePlansCollection listServicePlans(limit, offset, filter, sortBy)
...
import org.openapitools.client.api.ServicePlanApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicePlanApi apiInstance = new ServicePlanApi(defaultClient);
    ...
    try {
      ServicePlansCollection result = apiInstance.listServicePlans(limit, offset, filter, sortBy);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicePlanApi#listServicePlans");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ServicePlan result = apiInstance.showServicePlan(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicePlanApi#showServicePlan");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
